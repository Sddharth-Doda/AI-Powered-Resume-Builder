...
const SkillsForm = ({ data, onChange }) => {
  ...
  return (
    <div className='space-y-4'>
      <div>
        <h3> Skills </h3>
        <p className='text-sm text-gray-500'> Add your techincal and soft skills </p>
      </div>

      <div className='flex gap-2'>
        <input type="text" placeholder='Enter a skill (e.g. JavaScript, Project Management)' className='border border-gray-300 rounded-lg flex-1 px-3 py-2 text-sm' onChange={(e)=>setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress} />
